...
gulp.task('html', function () {
  return gulp.src('./src/app/templates/partials/*.html')
...
gulp.task('copy-translation', function() {
  gulp.src('./src/app/translation//**').pipe(gulp.dest('./dist/translation'));
});

gulp.task('copy-fonts', function() {
  gulp.src('./bower_components/bootstrap-material-design/fonts/**').pipe(gulp.dest('./dist/fonts'));
});
...
gulp.task('copy-libs', function() {
  gulp.src('./src/app/libs//**').pipe(gulp.dest('./dist/libs'));
});

gulp.task('copy', ['copy-translation', 'copy-fonts', 'copy-webconfig', 'copy-libs'], function() {
  gulp.src('./src/app/_slidebox.css').pipe(gulp.dest('./dist/'));
});

/**
 * Dist
 */
gulp.task('dist', ['vendors', 'assets', 'styles-dist', 'scripts-dist', 'html', 'copy'], function () {
  return gulp.src('./src/app/index.html')
...
gulp.task('watch', ['statics', 'default'], function () {
  ...
  gulp.watch(['./src/app/**/*.less']).on('change', function (evt) {
    if (evt.type !== 'changed') {
      // gulp.start('index');
    } else {
      // g.livereload.changed(evt);
