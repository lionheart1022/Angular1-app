angular
	...
	.factory('HubProxy', ['$rootScope', '$q', 'HubConnectionEvents', 'SignalRValue',
		function($rootScope, $q, ConnectionEvents, SignalRValue) {
			...
			function Hub(hubName, options) {
				...
				this.connection = $.hubConnection(settings.connectionPath,  { useDefaultPath: false });
				this.connection.qs = { 'Group': SignalRValue.token };
