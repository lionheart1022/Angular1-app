...
var VKI = function(customConfig, layout, deadKeys, keyInputCallback) {
  ...
  this.VKI_openKeyboard = config.openKeyboard || false; // true to Submit forms when Enter is pressed. Fn to execute a custom function.
  this.VKI_hideKeyboard = config.hideKeyboard || false; // true to Submit forms when Enter is pressed. Fn to execute a custom function.
  ...
  this.VKI_show = function(elem) {
    if (!this.VKI_target) {
      ...
      if (typeof self.VKI_openKeyboard === 'function') {
        self.VKI_openKeyboard.apply({});
      }
  ...
  this.VKI_close = function(keepFocus) {
    if (this.VKI_target) {
      ...
      if (typeof self.VKI_hideKeyboard === 'function') {
        self.VKI_hideKeyboard.apply({});
      }
